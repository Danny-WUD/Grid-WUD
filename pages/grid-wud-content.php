...
// Get the 'see more' image
	function wud_grid_wud_post2(){
		...
		$wud_grid_nr = 1; //1-> one grid, 2-> four grid, 3-> five grid (total 20 grid)
			...
			//-> Wrapper-start
			if($gw_shape == "4" ){
					$result .= "<div class='grid-wud-wrapper' id='grid-".$gw_shape."-wud-wrapper-".$wud_grid_nr."' style='border-radius: 50% !important;-webkit-border-radius: 50% !important;	-moz-border-radius: 50% !important; z-index: 10;' >"; 
			}
			else{
					$result .= "<div class='grid-wud-wrapper' id='grid-".$gw_shape."-wud-wrapper-".$wud_grid_nr."' style='border-radius:".$gwfuncs['grid_wud_round_img']."px; z-index:10; }' >"; 
			}	
