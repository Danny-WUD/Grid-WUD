...
*
* **Optional shortcodes**:
* [grids="2"] to display x grids /category or tag, different number then defined in the settings from Grid WUD.
...
* Sample: [wud grid="custom_post_type_name" cp="1"] or [wud grid="custom_post_type_name" cp="2"].
